import StepTwo from "@/assets/svgs/step-two.svg";
...
export default function OnboardingStepTwo() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <StepTwo width={350} height={350} />
      <View>
        <Typography variant="heading1" style={styles.title}>
          Manage Income, Track Expenses, Reach Goals.
        </Typography>

        <Typography variant="body" style={styles.description}>
          Pocka makes it easy to log every income and expense. Get a clear overview of where your money goes
        </Typography>
      </View>
